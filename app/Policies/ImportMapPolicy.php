...
class ImportMapPolicy
{
     ...
     */
    public function view(User $user, ImportMap $importMap): bool
    {
        return ($user->hasPermission('import:view') ||
           $user->hasTeamPermission($user->currentTeam, 'import:view')) &&
           $user->tokenCan('import:view');
     ...
     */
    public function update(User $user, ImportMap $importMap): bool
    {
     ...
     */
    public function delete(User $user, ImportMap $importMap): bool
    {
     ...
     */
    public function restore(User $user, ImportMap $importMap): bool
    {
        return ($user->hasPermission('import:delete') ||
           $user->hasTeamPermission($user->currentTeam, 'import:delete')) &&
           $user->tokenCan('import:delete');
     ...
     */
    public function forceDelete(User $user, ImportMap $importMap): bool
    {
        return ($user->hasPermission('import:delete') ||
           $user->hasTeamPermission($user->currentTeam, 'import:delete')) &&
           $user->tokenCan('import:delete');
